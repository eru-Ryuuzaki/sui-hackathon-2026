...
function App() {
  return (
    <div className="min-h-screen bg-void-black text-neon-cyan font-mono p-4 md:p-8 relative overflow-hidden flex flex-col">
      {/* Scanline Effect */}
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-6 relative z-10 flex-1">
